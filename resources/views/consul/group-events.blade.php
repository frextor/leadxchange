...
<div class="space-y-4">
    ...
    @php
        ...
        $color      = $typeColors[$event->type] ?? $event->cover_color ?? '#7C3AED';
            ...
            <div class="flex-1 px-5 py-4">
                <div class="flex items-start justify-between gap-4 flex-wrap">
                    <div class="flex-1 min-w-0">
                        <div class="flex items-center gap-2 flex-wrap mb-1">
                            ...
                            @else
                            <span class="text-[10px] px-2 py-0.5 rounded-full font-semibold" style="background:#EDE9FE;color:#6D28D9;">À venir</span>
                            @endif
                        </div>
                ...
                <div class="mt-3 pt-3 border-t border-gray-100">
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        <div class="flex items-center gap-1.5 bg-purple-50 rounded-lg px-2 py-1">
                            @if($p->profile?->avatar)
    ...
    <div class="bg-white rounded-2xl border border-gray-200 shadow-sm px-5 py-12 text-center">
        <div class="w-12 h-12 mx-auto mb-3 rounded-2xl flex items-center justify-center" style="background:#EDE9FE;">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#7C3AED" stroke-width="1.8"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
        </div>
