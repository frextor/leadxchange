    ...
    <aside class="w-56 flex-shrink-0 flex flex-col" style="background:#0F172A;">
        ...
        <nav class="flex-1 px-2.5 py-3 overflow-y-auto">
            ...
            <a href="{{ route('admin.super.settings.currency') }}"
               class="nav-item sa {{ request()->routeIs('admin.super.settings*') ? 'active' : '' }}">
            ...
            <a href="{{ route('admin.super.smtp.index') }}"
               class="nav-item sa {{ request()->routeIs('admin.super.smtp*') ? 'active' : '' }}">
                <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="M22 7l-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg>
                Email / SMTP
            </a>
            @endif
        </nav>
