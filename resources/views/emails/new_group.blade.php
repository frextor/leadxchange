...
@php $emailTitle = 'Nouveau groupe — ' . ($group_name ?? 'LeadXchange'); @endphp
...
<h1 style="font-family:'Newsreader',Georgia,'Times New Roman',serif;font-size:30px;font-weight:400;font-style:italic;color:#0F1623;line-height:1.25;margin:0 0 24px 0;">
  {{ $group_name ?? 'Un nouveau groupe vous attend' }}
</h1>
...
<p style="font-family:'Geist',-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;font-size:15px;line-height:1.7;color:#2E3850;margin:0 0 24px 0;">
  Un nouveau groupe vient d'être créé par <strong>{{ $creator_name }}</strong> dans votre région. Rejoignez la communauté et échangez des leads qualifiés avec d'autres professionnels.
</p>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation"
  ...
  <tr>
    <td style="padding:20px 24px;">
      ...
      @if(!empty($group_description) && $group_description !== 'Aucune description.')
      ...
      <table cellpadding="0" cellspacing="0" border="0" role="presentation">
        <tr>
          ...
          @endif
          @if(!empty($sector) && $sector !== 'Tous secteurs')
          <td>
            <p style="font-family:'Geist',-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;font-size:12px;color:#6B7280;margin:0;">
              🏷 {{ $sector }}
            </p>
  ...
  <tr>
    <td align="center">
      ...
      <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word"
        href="{{ $group_url }}" style="height:48px;v-text-anchor:middle;width:240px;"
