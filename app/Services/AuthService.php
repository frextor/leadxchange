...
class AuthService
{
    ...
    {
        $user->load(['company.sector', 'subscription.plan', 'profile', 'nationality', 'city', 'consulRequests', 'ambassadorCity', 'consulCity']);
        ...
        return [
            ...
            'consul_city'      => $user->consul_city_id ? [
                'id'   => $user->consul_city_id,
                'name' => $user->consulCity?->name,
            ] : null,
