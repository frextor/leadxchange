...
/**
 * Icônes Lucide utilisées par le nouveau design "LX2" (maquette LeadXchange WEB).
 * Un sous-ensemble de la bibliothèque complète — n'ajouter que ce qui est utilisé.
 */
class Lx2Icons
{
    protected static array $paths = [
        ...
        'lx-send'        => '<path d="M3.5 4.5h17L11.2 20.5z"/><path d="M3.5 4.5l7.7 7.2"/>',
    ...
    {
        $path = static::$paths[$name] ?? '';
        if ($path === '') {
            return '';
        }

        return '<svg class="i ' . $class . '" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">' . $path . '</svg>';
    }
}
